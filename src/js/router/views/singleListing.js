...
import { formatDate } from "../../api/constants";
...
export const displaySingleListing = (listing) => {
    ...
    nextButton.className = "next-button text-sm font-bold bg-primary hover:bg-secondary text-white px-4 py-2 rounded";
    ...
    prevButton.className = "prev-button text-sm font-bold bg-primary hover:bg-secondary text-white px-4 py-2 rounded";
    ...
    container.className = "listing-container p-6 bg-dark-100 mb-20 shadow-lg rounded-lg max-w-2xl mx-auto space-y-4";
    ...
    title.className = "listing-title text-lg font-semibold text-light";

    const description = document.createElement("p");
    description.innerText = listing.description || "No description provided.";
    description.className = "listing-description text-sm text-dart-100 leading-relaxed";

    const endsAt = document.createElement("h4");
    endsAt.innerText = `Ends At: ${formatDate(listing.endsAt)}`;
    endsAt.className = "mt-2";

    const currentBid = document.createElement("p");
    currentBid.className = "current-bid text-base font-semibold text-light";
    ...
    bidInput.min = "0";
    bidInput.className = "bid-input text-black border border-secondary rounded px-4 py-2 text-sm text-primary focus:outline-none focus:ring focus:ring-accent-primary";
    ...
    viewBiddersButton.className = "viewBiddersButton text-white py-2 mt-5 px-4 rounded-md hover:text-primary";
    ...
    editButton.className = "edit-button text-white px-4 py-2 rounded-md hover:text-primary";
